...
@Component({
  selector: 'app-kennels-maintainer',
  templateUrl: './kennels-maintainer.component.html',
  styleUrls: ['./kennels-maintainer.component.css']
})
export class KennelsMaintainerComponent extends BaseTableComponent implements OnInit {

  public dataRows: any[] = [];

  constructor(
    public route: ActivatedRoute,
    private kennelAllUseCase: KennelAllUseCase,
