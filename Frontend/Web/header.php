		...
		<div class="ms-wrap-header">
			...
			<div class="ms-main-menu">
				<nav>
					<ul>
                        ...
                        <li><a href="#contact" class="ms-item-scroll">Contacto</a></li>
					</ul>
			...
			<div class="ms-wrap-logo">
				<a href="/" class="ms-logo">
					<img data-real-type="image" data-img="<?php echo get_template_directory_uri(); ?>/img/logo/logo_c.svg" src="<?php echo get_template_directory_uri(); ?>/img/temp.png" alt="Pet Hotel Shangrila" class="mb">	
