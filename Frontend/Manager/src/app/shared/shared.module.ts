...
import { faSpinner, faSignInAlt, faBan, faSync, faDownload, faTrash, faPencilAlt, faMoneyBillAlt, faEye, faDog, faCaretRight, faUser, faBed, faCar, faCarAlt, faShoppingCart, faCalendar } from '@fortawesome/free-solid-svg-icons';
