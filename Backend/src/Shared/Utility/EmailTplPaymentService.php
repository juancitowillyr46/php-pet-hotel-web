...
class EmailTplPaymentService
{
    ...
    public function getGridTotal(): string
    {
        $body = '';
        $body .= '<tr>';
        $body .= '<td align="right" bgcolor="#eaeaea" style="padding: 13px; padding-left: 25px; color: #008193; font-family: Arial, Verdana, \'sans-serif\' !important; font-size: 15px" colspan="3">Total S/</td>';
        $body .= '<td align="right" bgcolor="#eaeaea" style="padding: 13px; padding-left: 25px; color: #008193; font-family: Arial, Verdana, \'sans-serif\' !important; font-size: 15px" colspan="1">'.$this->gridTotal.'</td>';
        $body .= '</tr>';
        return $body;
    }
                  ...
                  <td bgcolor="#FFFFFF">
                    <table width="680" border="0" cellpadding="0" cellspacing="0">
                      <tbody>
                        ...
                        <tr>
                          <td height="69" align="center" valign="middle" style="color: #008193; font-family: Arial, Verdana, \'sans-serif\' !important; font-size: 20px; font-weight: 500">Tu pago fue realizado con éxito, en breve confirmaremos tu pago:</td>
                        </tr>
