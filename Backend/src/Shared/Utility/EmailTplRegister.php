                ...
                <tr>
                  <td bgcolor="#FFFFFF">
                    <table width="680" border="0" cellpadding="0" cellspacing="0">
                      <tbody>
                        <tr>
                          <td width="678" align="center" valign="top" bgcolor="#F8F8F8"><img src="'.$this->path.'/img/mailing/mailing-logo.png" width="180" height="75" alt=""/></td>
                        </tr>
                        <tr>
                          <td height="139" align="center" valign="top" style="line-height: 0">
                            <img src="'.$this->path.'/img/mailing/mailin-header.png" width="680" height="139" alt=""/>
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td align="center" valign="middle">
                            ...
                            <table width="420" border="0" cellpadding="0" cellspacing="0" style="-webkit-border-radius: 10px;-moz-border-radius: 10px;border-radius: 10px; overflow: hidden;">
                              <tbody>
                                <tr>
                                  <td width="105" bgcolor="#008192" style="padding: 13px; padding-left: 25px; color: #ffa827; font-weight: 600; font-family: Arial, Verdana, \'sans-serif\' !important; font-size: 15px">Usuario</td>
                                  <td width="299" bgcolor="#f5f5f5" style="padding: 13px; padding-left: 25px; color: #008193; font-family: Arial, Verdana, \'sans-serif\' !important; font-size: 15px">'.$this->email.'</td>
                                </tr>
                                <tr>
                                  <td bgcolor="#007b8c" style="padding: 13px; padding-left: 25px; color: #ffa827; font-weight: 600; font-family: Arial, Verdana, \'sans-serif\' !important; font-size: 15px">Clave</td>
                                  <td bgcolor="#eaeaea" style="padding: 13px; padding-left: 25px; color: #008193; font-family: Arial, Verdana, \'sans-serif\' !important; font-size: 15px">'.$this->password.'</td>
                                </tr>
                              </tbody>
                            </table>
                          </td>
