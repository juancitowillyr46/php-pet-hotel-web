			...
			<div class="ms-top-header">
				...
				<div class="ms-wrap-login">
					<button class="ms-user-btn">
						<img data-real-type="image" data-img="<?php echo get_template_directory_uri(); ?>/img/profile/avatar_min.jpg"  src="<?php echo get_template_directory_uri(); ?>/img/temp.png" alt="Eduardo Rodriguez">
