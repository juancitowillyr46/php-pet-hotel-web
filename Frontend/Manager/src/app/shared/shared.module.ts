...
import { faSpinner, faSignInAlt, faBan, faSync, faDownload, faTrash, faPencilAlt, faMoneyBillAlt, faEye, faDog, faCaretRight, faUser, faBed } from '@fortawesome/free-solid-svg-icons';
